...
public class PlayerV1 : MonoBehaviour
{
    ...
    void Start()
    {
        em = FindFirstObjectByType<EnemyManagerV1>();
        curHealth = maxHealth;
    }
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        //OnTriggerEnter2D: Owning object must be Kinematic or Dynamic, other collider must be "Trigger"
    }

    void OnCollisionEnter2D(Collision2D collision)
    {
        Debug.Log("Collision");
        //Note: Fixed since made available on Canvas
